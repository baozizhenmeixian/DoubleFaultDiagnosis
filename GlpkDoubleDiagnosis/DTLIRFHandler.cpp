...
CDTLIRFHandler::CDTLIRFHandler(void)
{
}
...
//运行DLRF算法  
string CDTLIRFHandler::run(string dimensionValuesStr1, string dimensionValuesStr2, bool vOdd, vector<vector<CCell*>>& matrixCells, vector<int> allOTPs, vector<int> allUTPs, bool &hasEqualLRF)
{
